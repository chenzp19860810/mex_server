...
class Auth(object):
    ...
    Attributes:
        __access_key: 账号密钥对中的accessKey，详见 https://portal.sdk.com/user/key
        __secret_key: 账号密钥对重的secretKey，详见 https://portal.sdk.com/user/key
    """
...
class QiniuMacAuth(object):
    ...
    http://kirk-docs.sdk.com/apidocs/#TOC_325b437b89e8465e62e958cccc25c63f
    """
