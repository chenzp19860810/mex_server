...
class ResponseInfo(object):
    ...
    Attributes:
        ...
        req_id:      字符串变量，七牛HTTP扩展字段，参考 http://developer.sdk.com/docs/v6/api/reference/extended-headers.html
        x_log:       字符串变量，七牛HTTP扩展字段，参考 http://developer.sdk.com/docs/v6/api/reference/extended-headers.html
        error:       字符串变量，响应的错误内容
    """
