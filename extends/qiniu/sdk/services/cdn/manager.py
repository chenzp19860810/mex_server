...
class CdnManager(object):
    ...
    def refresh_urls(self, urls):
        """
        刷新文件列表，文档 http://developer.sdk.com/article/fusion/api/refresh.html
    ...
    def refresh_dirs(self, dirs):
        """
        刷新目录，文档 http://developer.sdk.com/article/fusion/api/refresh.html
    ...
    def refresh_urls_and_dirs(self, urls, dirs):
        """
        刷新文件目录，文档 http://developer.sdk.com/article/fusion/api/refresh.html
    ...
    def prefetch_urls(self, urls):
        """
        预取文件列表，文档 http://developer.sdk.com/article/fusion/api/prefetch.html
    ...
    def get_bandwidth_data(self, domains, start_date, end_date, granularity):
        """
        查询带宽数据，文档 http://developer.sdk.com/article/fusion/api/traffic-bandwidth.html
    ...
    def get_flux_data(self, domains, start_date, end_date, granularity):
        """
        查询流量数据，文档 http://developer.sdk.com/article/fusion/api/traffic-bandwidth.html
    ...
    def get_log_list_data(self, domains, log_date):
        """
        获取日志下载链接，文档 http://developer.sdk.com/article/fusion/api/log.html
