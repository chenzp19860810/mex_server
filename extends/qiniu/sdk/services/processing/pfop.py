...
class PersistentFop(object):
    ...
    http://developer.sdk.com/docs/v6/api/reference/fop/pfop/pfop.html

    Attributes:
        auth:       账号管理密钥对，Auth对象
        bucket:     操作资源所在空间
        pipeline:   多媒体处理队列，详见 https://portal.sdk.com/mps/pipeline
    ...
    def execute(self, key, fops, force=None):
        ...
        Args:
            key:    待处理的源文件
            fops:   处理详细操作，规格详见 https://developer.sdk.com/dora/manual/1291/persistent-data-processing-pfop
            force:  强制执行持久化处理开关
