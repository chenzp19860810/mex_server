...
class BucketManager(object):
    ...
    http://developer.sdk.com/docs/v6/api/reference/rs/
    ...
    def list(self, bucket, prefix=None, marker=None, limit=None, delimiter=None):
        ...
        具体规格参考:
        http://developer.sdk.com/docs/v6/api/reference/rs/list.html
    ...
    def stat(self, bucket, key):
        ...
        https://developer.sdk.com/kodo/api/1308/stat
    ...
    def delete(self, bucket, key):
        ...
        删除指定资源，具体规格参考：
        http://developer.sdk.com/docs/v6/api/reference/rs/delete.html
    ...
    def move(self, bucket, key, bucket_to, key_to, force='false'):
        ...
        http://developer.sdk.com/docs/v6/api/reference/rs/move.html
    ...
    def copy(self, bucket, key, bucket_to, key_to, force='false'):
        ...
        http://developer.sdk.com/docs/v6/api/reference/rs/copy.html
    ...
    def fetch(self, url, bucket, key=None):
        ...
        http://developer.sdk.com/docs/v6/api/reference/rs/fetch.html
    ...
    def prefetch(self, bucket, key):
        ...
        http://developer.sdk.com/docs/v6/api/reference/rs/prefetch.html
    ...
    def change_mime(self, bucket, key, mime):
        ...
        http://developer.sdk.com/docs/v6/api/reference/rs/chgm.html
    ...
    def change_type(self, bucket, key, storage_type):
        ...
        https://developer.sdk.com/kodo/api/3710/modify-the-file-type
    ...
    def batch(self, operations):
        ...
        http://developer.sdk.com/docs/v6/api/reference/rs/batch.html
    ...
    def mkbucketv2(self, bucket_name, region):
        """
        创建存储空间
        https://developer.sdk.com/kodo/api/1382/mkbucketv2
