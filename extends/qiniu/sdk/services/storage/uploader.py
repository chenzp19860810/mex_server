...
def put_data(
    ...
    Args:
        ...
        key:              上传文件名
        data:             上传二进制流
        params:           自定义变量，规格参考 http://developer.sdk.com/docs/v6/api/overview/up/response/vars.html#xvar
...
class _Resume(object):
    ...
    http://developer.sdk.com/docs/v6/api/reference/up/mkblk.html
    http://developer.sdk.com/docs/v6/api/reference/up/mkfile.html
