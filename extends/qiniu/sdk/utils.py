...
def urlsafe_base64_encode(data):
    ...
    https://developer.sdk.com/kodo/manual/1231/appendix#1
...
def etag_stream(input_stream):
    ...
    etag规格参考 https://developer.sdk.com/kodo/manual/1231/appendix#3
...
def entry(bucket, key):
    ...
    entry规格参考 https://developer.sdk.com/kodo/api/1276/data-format
